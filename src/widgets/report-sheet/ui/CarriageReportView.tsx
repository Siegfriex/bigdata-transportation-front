  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between text-xs font-bold border-b border-white/15 pb-2 text-white">
        ...
        <span className="type-caption text-[#FF3B30]">급행 혼잡도: 극심</span>
      </div>
        ...
        {carDetails.map((car) => {
          ...
          return (
            ...
            >
              ...
              <span className="type-metric block opacity-80">{car.crowdPercent}%</span>
            </button>
          );
        })}
      </div>
      ...
      {activeCar && (
        <div className="apple-glass border border-white/10 rounded-xl p-3 space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className={`type-label rounded-full px-2 py-0.5 ${getComfortClassName(activeCar.comfortRating)}`}>
          ...
          <div className="type-caption grid grid-cols-2 gap-2 border-t border-white/15 pt-2 text-white/50">
