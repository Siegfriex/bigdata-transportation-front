...
export function SettingsForm({
  ...
  return (
    <div className="z-layer-page absolute inset-0 flex-1 space-y-4 overflow-y-auto bg-black/80 p-4 backdrop-blur-3xl pointer-events-auto">
      <div className="space-y-2.5">
        ...
        <div className="surface-card stack-md p-3.5">
          ...
          <button
            ...
            className="control-base focus-ring w-full rounded-xl bg-[#0A84FF] py-2 text-xs font-bold text-white"
          >
            기본 루틴으로 지도 동기화
          </button>
        </div>
      ...
      <div className="space-y-2.5">
        <span className="type-label block text-white/50">세부 이동 조건</span>
        <div className="surface-card overflow-hidden divide-y divide-[#25282B]">
          <div className="p-3">
            <label className="flex justify-between items-center text-xs text-white">
              ...
              <select
                ...
                className="focus-ring rounded border border-white/10 bg-white/[0.07] px-2 py-1 text-[11px] font-bold text-[#74B9FF] outline-none"
              >
          ...
          <div className="p-3 flex items-center justify-between">
            ...
            <button
              ...
              className={`focus-ring relative h-5 w-10 rounded-full outline-none transition-all ${
      ...
      <div className="space-y-2.5">
        <span className="type-label block text-white/50">AI 챗봇 브리핑 스타일</span>
        <div className="surface-card flex gap-1 p-2">
          {aiStyleOptions.map((style) => (
            <button
              ...
              className={`control-base focus-ring flex-1 rounded-lg border py-1.5 text-center text-[10px] font-bold ${
      ...
      <div className="space-y-2.5">
        <span className="type-label block text-white/50">공공데이터 예측 출처 안내</span>
        <div className="surface-card stack-sm p-3.5 text-[10.5px] leading-relaxed text-white/70">
          <div className="flex items-center justify-between border-b border-white/15 pb-1.5 text-white">
            <span className="font-bold">{publicDataSourceNotice.heading}</span>
            <span className="type-caption text-[#0A84FF]">{publicDataSourceNotice.statusLabel}</span>
          </div>
          ...
          <div className="apple-glass-light flex items-center gap-1 rounded-lg p-2 text-[9.5px] font-medium leading-relaxed text-white/50">
      ...
      <div className="text-center pt-2 space-y-1">
        <span className="type-caption block text-white/50">탈수있나 Metropolitan FSD Platform v0.1</span>
        <span className="type-label block text-white/45">국토교통 공공 데이터 활용 경진대비 출품작</span>
      </div>
    </div>
  );
}
